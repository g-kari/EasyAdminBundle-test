...
class TUserRole
{
    ...
    #[ORM\JoinColumn(name: "m_user_role_id", nullable: false)]
    private ?MUserRole $mUserRole = null;
    ...
    public function getMUserRole(): ?MUserRole
    {
        return $this->mUserRole;
    }

    public function setMUserRole(?MUserRole $mUserRole): static
    {
    ...
    {
        return ($this->getTUser() ? $this->getTUser()->getUserName() : '') . ' - ' . 
               ($this->getMUserRole() ? $this->getMUserRole()->getRoleName() : '');
    }
}